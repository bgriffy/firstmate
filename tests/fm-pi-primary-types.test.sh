...
cp "$ROOT/.pi/extensions/fm-toggle-no-mistakes.ts" "$TMP_ROOT/fm-toggle-no-mistakes.ts"
...
cp "$ROOT/.pi/extensions/lib/fm-toggle-no-mistakes-choices.ts" "$TMP_ROOT/lib/fm-toggle-no-mistakes-choices.ts"
